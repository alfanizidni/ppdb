    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
        <div class="full">
          ...
          <div class="blog_section">
            <div class="blog_feature_img"> <img class="img-responsive" src="<?php echo base_url('images/it_service/dark_bg_img2.png') ?>" alt="#"> </div>
            <div class="blog_feature_cantant">
              <p class="blog_head">Blogpost With Image</p>
              <div class="post_info">
                <ul>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
        <div class="full">
          <div class="blog_section">
            <div class="blog_feature_img"> <img class="img-responsive" src="<?php echo base_url('images/it_service/post-03.jpg') ?>" alt="#"> </div>
          </div>
          ...
          <div class="blog_section">
            <div class="blog_feature_img"> <img class="img-responsive" src="<?php echo base_url('images/it_service/dark_bg_img.png') ?>" alt="#"> </div>
          </div>
        </div>
      </div>
      <div class="center">
