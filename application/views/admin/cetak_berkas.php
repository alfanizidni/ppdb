                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 appointment_form"> 
                  ...
                  <form class="form_contant" action="admin/pendaftaran/tambah_aksi" method="post" style="padding-left: 30px; padding-right:30px; width:1000px; display:block;">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-lg-3 col-md-3 col-sm-3 col-xs-3">
                          <input class="form-control" placeholder="Tanggal Lahir" type="date" required style="margin-top: 23px;">
                        </div>
                      </div>
                      <div class="row">
                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-6">
                      ...
                      <div class="row">
                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-6">
                          ...
                          <textarea class="form-control" rows="6" placeholder="1. 2. 3. dst" type="text" required></textarea>
                        </div>
                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-6">
